            ...
            child: Column(
              children: [
                ...
                _MenuTile(
                  ...
                  title: "Share App",
                  subtitle: "Send APK via Wi‑Fi Direct",
                  onTap: () => Navigator.push(
                    context,
                ...
                _MenuTile(
                  ...
                  color: AppColors.gridCyan,
                  title: "Switch mode (calculator)",
                  subtitle:
                      "Enter REAL or decoy PIN — separate chats and vault per mode",
                  onTap: () => Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (_) => const CalculatorGate(),
                    ),
                  ),
                ),
                const SizedBox(height: 10),
                _MenuTile(
                  ...
                  color: AppColors.cloudGreen,
                  title: "E2EE — приоритеты и FAQ",
                  subtitle:
                      "Почему не «как Signal», TOFU, mesh; полный текст на GitHub: SECURITY.md, ARCHITECTURE.md",
                  onTap: () => Navigator.push(
                    context,
                    MaterialPageRoute(builder: (_) => const E2eeDocsScreen()),
                  ),
                ),
                const SizedBox(height: 10),
                _MenuTile(
