...
///
/// 🔒 КОНТРАКТ САМОРАЗВИТИЯ: PeerCache и производные метрики — только для
/// накопления опыта и (в будущем) мягких подсказок. Ни один компонент не должен
/// менять решение об отправке/релее/выборе канала исключительно на основе
/// PeerCache без явного контракта и тестов. Решения в sendAuto, Repeater и выборе
/// канала остаются на основе состояния (флаги, списки узлов, таймауты), а не score.
