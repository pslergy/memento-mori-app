...
/// [dr_handshake_outbox] row written/updated — BLE peripheral should try immediate notify flush.
class DrHandshakeOutboxEnqueuedEvent {
  final String targetUserId;
  DrHandshakeOutboxEnqueuedEvent(this.targetUserId);
}
