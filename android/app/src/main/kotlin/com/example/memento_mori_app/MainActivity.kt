...
class MainActivity : FlutterFragmentActivity() {
    ...
    override fun configureFlutterEngine(@NonNull engine: FlutterEngine) {
        ...
        // [WIFI-DIAG] 1. Инициализация: Channel создан? Manager null? Thread name
        ...
        // 🔊 Sonar RX: приёмник с callback в Flutter (memento/sonar), частоты совпадают с TX (19800/20400)
    ...
    // [WIFI-DIAG] 6. Lifecycle: только логирование, без вызова removeGroup и без смены логики
...
class AcousticReceiver(private val onSignalDetected: (String) -> Unit) {
    ...
    // 🔧 RX aligned with Dart TX (UltrasonicService: 19800/20400 Hz) — transport unchanged
